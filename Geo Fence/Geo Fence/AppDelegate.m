...
-(void) application: (UIApplication *)application didReceiveLocalNotification:(nonnull UILocalNotification *)notification{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Welcome to Woody's Wonderful Woodshop!" message:notification.alertBody preferredStyle:UIAlertActionStyleDefault];
